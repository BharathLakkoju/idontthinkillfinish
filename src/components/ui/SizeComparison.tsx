...
export function SizeComparison({ originalSize, compressedSize }: SizeComparisonProps) {
        ...
        <div className="w-full card-premium bg-gradient-to-br from-card to-secondary/5 border-primary/20 p-8">
            <div className="flex flex-col md:flex-row items-center justify-between gap-8">
                <div className="text-center md:text-left">
                    <p className="text-xs uppercase tracking-widest text-foreground/50 font-bold mb-2">Original</p>
                ...
                <div className="flex flex-col items-center">
                    ...
                    <p className="text-xs font-bold text-primary">{reduction.toFixed(1)}% Smaller</p>
                </div>

                <div className="text-center md:text-right">
                    <p className="text-xs uppercase tracking-widest text-primary font-bold mb-2">Compressed</p>
                    <p className="text-2xl font-bold text-primary">{formatSize(compressedSize)}</p>
                </div>
            </div>
            ...
            <div className="mt-8 flex items-center justify-center space-x-6 pt-6 border-t border-border/50">
                <div className="flex items-center space-x-2 text-sm text-foreground/60">
                    ...
                    <span>Storage saved: {formatSize(originalSize - compressedSize)}</span>
                </div>
