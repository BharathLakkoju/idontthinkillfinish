...
export function CompressImageClient() {
    ...
    const [result, setResult] = useState<{ blob: Blob | File; url: string; size: number } | null>(null);
    ...
    const handleCompress = async () => {
        ...
        try {
            const compressedFile = await compressImage(file, {
                maxSizeMB: quality * 2, // approximation
                ...
                {!file ? (
                    ...
                    <div className="space-y-8 animate-in fade-in duration-500">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div className="space-y-4">
                                <label className="flex items-center justify-between font-bold text-sm uppercase tracking-wider opacity-60">
                                    ...
                                    <span className="text-rose-500">{Math.round(quality * 100)}%</span>
                                </label>
                                <input
                                    type="range"
                                    min="0.1"
                        ...
                        <div className="pt-6 border-t border-border flex flex-col items-center space-y-6">
                            ...
                            {isProcessing && (
                                <ProgressBar progress={progress} label="Optimizing image pixels..." />
                            )}
